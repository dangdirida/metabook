    ...
    <div className="min-h-screen bg-[var(--color-mono-010)]">
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 py-6 md:py-8">
        ...
        <div className="bg-white rounded-2xl border border-[var(--color-mono-080)] overflow-hidden">
          {/* 썸네일 / 그라데이션 플레이스홀더 */}
          <div className="relative h-48 md:h-auto md:aspect-[16/7] overflow-hidden">
            {creation.thumbnail ? (
          ...
          <div className="p-6 md:p-8 space-y-5">
            {/* 제목 */}
            <h1 className="text-xl md:text-2xl font-bold text-[var(--color-mono-990)]">{creation.title}</h1>
